                    ...
                    <div id="collapseEleven" class="panel-collapse collapse">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="tab-nav" role="tablist">
                                ...
                                <label>
                                        <img :src="miscs_src+misc2.img_link" height="100" width="100" @click="initloadMiscs2(index)">
                                    </label>
                                    <p>{{misc2.name}}</p>
                                </li>
...
<div class="modal-content">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
            aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">Confirm {{update_misc2.name}} Selection</h4>
        </div>
        <div class="modal-body">
           ...
           <div class="form-group">
                    <label>{{update_misc2.name}}</label>
                    <img :src="miscs_src+update_misc2.img_link" height="250" width="250" >
                </div>

                <div class="form-group">
                    <label>Name:</label>
                    <input type="hidden" class="form-control" name="misc2" id="misc2" v-model="update_misc2.name">
                </div>
            </form>
        </div>
        <div class="modal-footer">
