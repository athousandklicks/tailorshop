              ...
              <table class="table">
                ...
                <tbody>
                 ...
                 <tr>
                  ...
                  <td>{{ $button->name }}</td>
                  <td>
                    <i class="btn-action"><a href="{{route('button.edit', $button->id)}}" class="fa fa-edit"></a></i>
                  </td>
                  <td>{!!Form::open(['route' => ['button.destroy', $button->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()'])
                    !!}
