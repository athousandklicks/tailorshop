            ...
            <div class="row">
              ...
              <table class="table">
                ...
                <tbody>
                 ...
                 <tr>
                  <td>{{ $embroidery->id }}</td>
                  <td>{{ $embroidery->name }}</td>
                  <td>
                    <i class="btn-action"><a href="{{route('embroidery.edit', $embroidery->id)}}" class="fa fa-edit"></a></i>
                  </td>
                  <td>{!!Form::open(['route' => ['embroidery.destroy', $embroidery->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()'])
                    !!}
