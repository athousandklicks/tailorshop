      ...
      <div class="col-lg-9 col-md-9 col-sm-12 pull-right">
        <div id="content" class="haslayout">
          ...
          <fieldset>
            ...
            <div class="row">
              <div class="form-group col-sm-9 col-xs-12">
              {{Form::label('reference_no', 'Enter Unique Product Reference No. *')}}
                {{Form::text('reference_no', null, ['class' => 'form-control', 'placeholder'=>'Enter Product Unique No. This no is not editable after creation'])}}
              </div>
            </div>
